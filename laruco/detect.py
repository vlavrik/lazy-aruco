                ...
                if draw_annotations:
                    ...
                    if corners:
                        for i in range(len(corners)):
                            x1, y1 = int(corners[i][0][0][0]), int(
                                corners[i][0][0][1])
                            x2, y2 = int(corners[i][0][1][0]), int(
                                corners[i][0][1][1])
                            x3, y3 = int(corners[i][0][2][0]), int(
                                corners[i][0][2][1])
                            x4, y4 = int(corners[i][0][3][0]), int(
                                corners[i][0][3][1])
                            ...
                            cX = x1 + int((x2 - x1) / 2.0)
                            cY = y1 + int((y4 - y1) / 2.0)
                            cv2.putText(frame, 'ID:' + str(ids[i][0]), (cX, cY),
                                        cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0), 1, cv2.LINE_AA)
